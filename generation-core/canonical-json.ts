...
function normalize(value: unknown, path: string): JsonValue {
  ...
  if (typeof value === "object") {
    ...
    if (prototype !== Object.prototype && prototype !== null) throw new Error(`non_plain_object:${path}`);
...
export type CanonicalHasher = (canonicalContent: string) => string;

export function hashCanonical(value: unknown, hasher: CanonicalHasher): string {
